...
# npx html-minifier-terser --collapse-whitespace --remove-comments --minify-css true --minify-js true ./boost/src/custom_modules/artifacts/fluid/dist/fluid_built.html -o ./boost/src/custom_modules/artifacts/fluid_mini.html
