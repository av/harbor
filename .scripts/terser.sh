...
npx html-minifier-terser --collapse-whitespace --remove-comments --minify-css true --minify-js true ./boost/src/custom_modules/artifacts/logprobs.html -o ./boost/src/custom_modules/artifacts/logprobs_mini.html
