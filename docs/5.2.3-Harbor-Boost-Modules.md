...
- Ad hoc sandbox example: `agent-code=tools,sightline,final` with
  `HARBOR_BOOST_TOOLS` including `read_workspace_file;write_workspace_file;grep_workspace`
...
also available. `write_workspace_file` is **not** in the default tool list — add
