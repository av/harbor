...
> [!NOTE]
> Harbor also ships [Speaches](./2.2.14-Backend%3A-Speaches.md) — a newer OpenAI-compatible STT/TTS server that supersedes `faster-whisper-server`. Consider using `speaches` for new setups.
