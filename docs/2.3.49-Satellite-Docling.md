...
You can set extra environment variables for Docling via [`harbor env`](./3.-Harbor-CLI-Reference.md#harbor-env). See the official [configuration reference](https://github.com/docling-project/docling-serve/blob/main/docs/configuration.md) for more options.
