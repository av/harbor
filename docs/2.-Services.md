...
- [AnythingLLM](https://github.com/av/harbor/wiki/2.1.9-Frontend:-AnythingLLM) <span style="opacity: 0.5;">`Frontend`, `Partial Support`, `RAG`</span><br/>
The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.

- [AstrBot](https://github.com/av/harbor/wiki/2.3.63-Satellite-AstrBot) <span style="opacity: 0.5;">`Satellite`, `Frontend`, `Tools`</span><br/>
...
- [ComfyUI](https://github.com/av/harbor/wiki/2.1.2-Frontend:-ComfyUI) <span style="opacity: 0.5;">`Frontend`, `Workflows`, `Image`</span><br/>
...
- [Lobe Chat](https://github.com/av/harbor/wiki/2.1.5-Frontend:-Lobe-Chat) <span style="opacity: 0.5;">`Frontend`, `RAG`</span><br/>
...
- [Onyx](https://github.com/av/harbor/wiki/2.1.14-Frontend-Onyx) <span style="opacity: 0.5;">`Frontend`, `Workflows`, `RAG`</span><br/>
Open Source AI Platform with Chat UI, RAG, MCP support, and 40+ document connectors.

- [Open WebUI](https://github.com/av/harbor/wiki/2.1.1-Frontend:-Open-WebUI) <span style="opacity: 0.5;">`Frontend`, `RAG`</span><br/>
...
- [SGLang](https://github.com/av/harbor/wiki/2.2.12-Backend:-SGLang) <span style="opacity: 0.5;">`Backend`, `Image`</span><br/>
...
- [Activepieces](https://github.com/av/harbor/wiki/2.3.64-Satellite-Activepieces) <span style="opacity: 0.5;">`Satellite`, `Workflows`</span><br/>
Open-source workflow automation platform with AI capabilities and 200+ app connectors.

- [Agent Zero](https://github.com/av/harbor/wiki/2.3.47-Satellite-Agent-Zero) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
General-purpose personal assistant with Web RAG, persistent memory, tools, browser use and more.

- [aichat](https://github.com/av/harbor/wiki/2.3.14-Satellite:-aichat) <span style="opacity: 0.5;">`Satellite`, `CLI`, `RAG`</span><br/>
...
- [Airweave](https://github.com/av/harbor/wiki/2.3.48-Satellite-Airweave) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
...
- [Browser Use](https://github.com/av/harbor/wiki/2.3.50-Satellite-Browser-Use) <span style="opacity: 0.5;">`Satellite`, `Partial Support`</span><br/>
AI-powered browser automation with web UI

- [cloudflared](https://github.com/av/harbor/wiki/2.3.8-Satellite:-cloudflared) <span style="opacity: 0.5;">`Satellite`, `API`, `CLI`, `Infra`</span><br/>
...
- [DeerFlow](https://github.com/av/harbor/wiki/2.3.65-Satellite-DeerFlow) <span style="opacity: 0.5;">`Satellite`, `RAG`, `Workflows`</span><br/>
...
- [Docling](https://github.com/av/harbor/wiki/2.3.49-Satellite-Docling) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
...
- [Home Assistant](https://github.com/av/harbor/wiki/2.3.60-Satellite-Home-Assistant) <span style="opacity: 0.5;">`Satellite`</span><br/>
...
- [Khoj](https://github.com/av/harbor/wiki/2.3.67-Satellite-Khoj) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
AI second brain for chat, search, and agents with your docs. Supports local and cloud LLMs.

- [KoboldCpp](https://github.com/av/harbor/wiki/2.2.16-Backend:-KoboldCpp) <span style="opacity: 0.5;">`Satellite`, `Frontend`, `Backend`</span><br/>
KoboldCpp is an easy-to-use AI text-generation software for GGML and GGUF models.

- [Kotaemon](https://github.com/av/harbor/wiki/2.3.61-Satellite-Kotaemon) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
An open-source RAG-based tool for chatting with your documents.

- [LangFlow](https://github.com/av/harbor/wiki/2.3.32-Satellite:-LangFlow) <span style="opacity: 0.5;">`Satellite`, `Workflows`, `RAG`</span><br/>
A low-code app builder for RAG and multi-agent AI applications.

- [LangFuse](https://github.com/av/harbor/wiki/2.3.6-Satellite:-langfuse) <span style="opacity: 0.5;">`Satellite`, `API`, `Infra`</span><br/>
...
- [LiteLLM](https://github.com/av/harbor/wiki/2.3.5-Satellite:-LiteLLM) <span style="opacity: 0.5;">`Satellite`, `API`, `Infra`</span><br/>
...
- [LocalAI](https://github.com/av/harbor/wiki/2.3.46-Satellite-LocalAI) <span style="opacity: 0.5;">`Satellite`, `Image`</span><br/>
...
- [MCP Forge](https://github.com/av/harbor/wiki/2.3.62-Satellite-MCP-Forge) <span style="opacity: 0.5;">`Satellite`, `Tools`</span><br/>
...
- [Morphic](https://github.com/av/harbor/wiki/2.3.34-Satellite-Morphic) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
...
- [Netdata](https://github.com/av/harbor/wiki/2.3.54-Satellite-Netdata) <span style="opacity: 0.5;">`Satellite`, `Infra`</span><br/>
Real-time infrastructure monitoring with per-second metrics for systems, containers, and applications.

- [OmniParser](https://github.com/av/harbor/wiki/2.3.30-Satellite:-OmniParser) <span style="opacity: 0.5;">`Satellite`, `Image`</span><br/>
...
- [Open Notebook](https://github.com/av/harbor/wiki/2.3.59-Satellite-Open-Notebook) <span style="opacity: 0.5;">`Satellite`</span><br/>
...
- [OptiLLM](https://github.com/av/harbor/wiki/2.3.33-Satellite:-OptiLLM) <span style="opacity: 0.5;">`Satellite`, `API`, `Infra`</span><br/>
Optimising LLM proxy that implements many advanced workflows to boost the performance of the LLMs.

- [Perplexica](https://github.com/av/harbor/wiki/2.3.2-Satellite:-Perplexica) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
An AI-powered search engine. It is an Open source alternative to Perplexity AI.

- [PhotoPrism](https://github.com/av/harbor/wiki/2.3.66-Satellite-PhotoPrism) <span style="opacity: 0.5;">`Satellite`, `Image`</span><br/>
...
- [Presenton](https://github.com/av/harbor/wiki/2.1.13-Frontend-Presenton) <span style="opacity: 0.5;">`Satellite`</span><br/>
...
- [Qdrant](https://github.com/av/harbor/wiki/2.3.26-Satellite:-Qdrant) <span style="opacity: 0.5;">`Satellite`, `RAG`, `Infra`</span><br/>
Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine.

- [RAGLite](https://github.com/av/harbor/wiki/2.3.39-Satellite-RAGLite) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
...
- [SuperGateway](https://github.com/av/harbor/wiki/2.3.44-Satellite-supergateway) <span style="opacity: 0.5;">`Satellite`, `CLI`, `Tools`, `Infra`</span><br/>
...
- [Traefik](https://github.com/av/harbor/wiki/2.3.37-Satellite-traefik) <span style="opacity: 0.5;">`Satellite`, `API`, `Infra`</span><br/>
A modern HTTP reverse proxy and load balancer that makes deploying microservices easy.

- [txtai RAG](https://github.com/av/harbor/wiki/2.3.11-Satellite:-txtai-RAG) <span style="opacity: 0.5;">`Satellite`, `RAG`</span><br/>
RAG WebUI built with txtai.

- [Unsloth](https://github.com/av/harbor/wiki/2.3.51-Satellite-Unsloth) <span style="opacity: 0.5;">`Satellite`</span><br/>
