...
The service runs inside a [Webtop](./2.3.29-Satellite-Webtop.md) desktop environment, giving it access to a graphical session for computer-use tasks.
...
- [Webtop](./2.3.29-Satellite-Webtop.md) — graphical desktop environment used by Harbor Agent
- [Open WebUI](./2.1.1-Frontend%3A-Open-WebUI.md) — can connect to the agent API as an OpenAI-compatible backend
