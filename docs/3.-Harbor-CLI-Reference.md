...
> Aliases: `harbor models list` = `harbor models ls`, `harbor models remove` = `harbor models rm`, `harbor models dmr pull ...` = `harbor models pull --source dmr ...`, `harbor models omlx pull ...` = `harbor models pull --source omlx ...`
...
With `--source dmr`, Harbor delegates to Docker Model Runner. With `--source mlx`, Harbor delegates to `harbor mlx pull`, which downloads HuggingFace model repos into the local cache. With `--source omlx`, Harbor delegates to `harbor omlx pull`, which downloads HuggingFace model repos into `HARBOR_OMLX_MODEL_DIR`.
...
| `omlx.workspace` | `./services/omlx` | Working directory for oMLX |
