...
- [SearXNG](./2.3.1-Satellite%3ASearXNG.md) — web search backend used by Perplexideez
- [Perplexica](./2.3.2-Satellite%3APerplexica.md) — similar AI-powered search service
- [Ollama](./2.2.1-Backend%3AOllama.md) — default LLM backend
