...
HARBOR_UNSLOTH_WORKSPACE="./services/unsloth/workspace"  # Local workspace directory
...
cp my_dataset.json $(harbor home)/services/unsloth/workspace/
...
- [Jupyter](./2.3.18-Satellite&colon-JupyterLab) - Standard Jupyter Lab environment
- [vLLM](./2.2.3-Backend&colon-vLLM) - For serving fine-tuned LLMs
