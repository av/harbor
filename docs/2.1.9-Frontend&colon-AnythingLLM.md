...
- [Ollama](./2.2.1-Backend&colon-Ollama.md) - You'll still need to select specific models for LLM and embeddings
- [llama.cpp](./2.2.2-Backend&colon-llama.cpp.md) - Embeddings are not pre-configured
- [SearXNG](2.3.1-Satellite&colon-SearXNG.md) for Web RAG, but still needs to be enabled in the UI
