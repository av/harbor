...
[Docker Model Runner](./2.2.22-Backend-Docker-Model-Runner.md) is useful when you want Docker Desktop to manage the local model runtime while Harbor services consume a normal OpenAI-compatible endpoint.
...
- You want Docker Desktop to manage the host model runtime.
