...
The default configuration uses Ollama with `qwen3:30b`. When started alongside Ollama, Harbor automatically configures the Ollama URL:
...
- For general diagrams: `qwen3:30b` is the seeded Harbor default and a reasonable baseline
