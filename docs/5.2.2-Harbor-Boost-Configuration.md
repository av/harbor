 Container harbor-boost-run-f48fea301d10 Creating 
 Container harbor-boost-run-f48fea301d10 Created 
...
When true, the `autocheck` module prepends a warning banner to the final answer when critical or major audit findings remain after all revise passes.
