...
Harbor lets you run local LLMs and 50+ AI services with simple commands. Get Open WebUI + Ollama running in minutes, no cloud required.
...
Harbor is a containerized toolkit that runs on top of Docker. This enables Harbor to support 50+ services and work across platforms. The sections below guide you through setting up Docker and all prerequisites.
...
Same as the quick install script, but manual:
