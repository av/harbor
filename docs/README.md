...
- [Harbor Guides](https://github.com/av/harbor/wiki/8.-Guides)<br/>
  ...
  Start with [Local LLM Stack with Docker Compose](https://github.com/av/harbor/wiki/8.1-Local-LLM-Stack-with-Docker-Compose) or [Ollama + Open WebUI + SearXNG Local Web RAG Setup](https://github.com/av/harbor/wiki/8.2-Ollama-Open-WebUI-SearXNG-Local-Web-RAG-Setup).
