...
- [./services/librechat/librechat.yml](../blob/main/services/librechat/librechat.yml) - main configuration file
- [./services/librechat/override.env](../blob/main/services/librechat/override.env) - service-specific environment variable overrides