...
**Note:** During the first start, TensorTruth will download pre-built vector indexes (~500MB) from Google Drive. This initial download takes 2-5 minutes depending on your network speed. Subsequent starts are instant as the data persists in the volume.
