...
export function IconBrandOllama(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
...
export function IconSquirrel({ className, ...rest }: SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
...
export function IconBookMarked({
    className,
    ...rest
    ...
    return (
        <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={`lucide lucide-book-marked ${className}`}
            {...rest}
        >
...
export function IconMoveLeft({ className, ...rest }: SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={`lucide lucide-move-left ${className}`}
            {...rest}
        >
...
export function IconPocketKnife({ className, ...rest }: SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
