...
Please do NOT set --with-chartmuseum, as chartmuseum has been deprecated and removed.
...
"/mnt/c/Program Files (x86)/Harbor/harbor-final/hahbah-fork/harbor/prepare" $prepare_para
echo ""
